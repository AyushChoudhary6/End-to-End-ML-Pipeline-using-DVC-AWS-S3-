...
Feel free to open issues or PRs. If adding stages, update `dvc.yaml` and push changes to remote.
...
- Add a `requirements.txt` produced from the venv,
- Add a minimal `README` badge or CI instructions,
- Or update `params.yaml` with more documented fields.
